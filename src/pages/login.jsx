    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-tag {
          font-size: 9px; letter-spacing: 0.2em; color: #f59e0b;
          margin-bottom: 12px; display: flex; align-items: center; gap: 8px;
        }
        .auth-tag-dot {
          width: 5px; height: 5px; border-radius: 50%; background: #f59e0b;
          animation: blink 2s ease infinite; box-shadow: 0 0 8px #f59e0b;
        }
        .auth-title {
          font-family: 'Bebas Neue', sans-serif; font-size: 36px;
          letter-spacing: 0.04em; color: #f0f0f0; line-height: 1;
        }
        .auth-title span { color: #f59e0b; }
        .auth-body { padding: 32px; }
        .auth-field { margin-bottom: 20px; }
        .auth-label {
          display: block; font-size: 9px; letter-spacing: 0.18em; color: rgba(232,232,232,0.35);
        ...
        .auth-input {
          ...
          color: #e8e8e8; font-family: 'IBM Plex Mono', monospace; font-size: 13px;
          outline: none; transition: border-color 0.2s, background 0.2s, box-shadow 0.2s;
        }
        .auth-input:focus {
          border-color: rgba(245,158,11,0.5); background: rgba(245,158,11,0.03);
        ...
        .auth-error {
          ...
          border-radius: 2px; font-size: 11px; color: #fca5a5; margin-bottom: 20px;
        }
        .auth-btn {
          width: 100%; padding: 13px; background: #f59e0b; color: #080808;
        ...
        .auth-footer {
          ...
          font-size: 11px; color: rgba(232,232,232,0.3); text-align: center;
        }
        ...
        .auth-divider-text { font-size: 10px; color: rgba(232,232,232,0.2); letter-spacing: 0.1em; }
      `}</style>

      <div className="auth-root">
        <div className="auth-scan" style={{ backgroundImage:"repeating-linear-gradient(0deg, rgba(255,255,255,0.5) 0px, rgba(255,255,255,0.5) 1px, transparent 1px, transparent 2px)", backgroundSize:"100% 2px" }} />
